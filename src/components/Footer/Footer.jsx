        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office_info">Colombo Rd, Kurunegala, Sri Lanka</p>
              <p className="office_info">Phone: +94 37 1 234 567</p>

              <p className="office_info">Email: info@rentcar.com</p>
          ...
          <Col lg="12">
            <div className="footer_bottom">
              <p className="section_description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                Witrix Holdings. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
